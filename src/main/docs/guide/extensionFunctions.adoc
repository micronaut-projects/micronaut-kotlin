...
dependency:io.micronaut.kotlin:micronaut-kotlin-extension-functions:{version}[]
...
[source,kotlin]
----
include::kotlin-extension-functions/src/main/kotlin/io/micronaut/http/HttpClientExtensions.kt[tags=clientFunctionSingle]

include::kotlin-extension-functions/src/main/kotlin/io/micronaut/http/HttpClientExtensions.kt[tags=clientFunctionList]
----
...
[source,kotlin]
----
include::kotlin-extension-functions/src/test/kotlin/io/micronaut/http/HttpClientExtensionsTest.kt[tags=usingClientFunctions, indent="0"]
----
