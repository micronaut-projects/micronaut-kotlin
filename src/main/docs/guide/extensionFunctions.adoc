...
NOTE: You will need to import the functions like this: `import io.micronaut.kotlin.retrieveObject`

Full documentation of the provided extension functions can be found via https://micronaut-projects.github.io/micronaut-kotlin/latest/guide/[the dokka docs for this project].
